...
class CoreEntry(models.Model):
    ...
    def get_imagen_video(instance, filename):
        ...
        return '/'.join([
            ...
            now.strftime('%m'),
            now.strftime('%d'),
        instance.slug, 'video', filename])
    video_uno = models.FileField(null=True, blank=True, upload_to=get_imagen_video, verbose_name="video_uno")
    video_dos = models.FileField(null=True, blank=True, upload_to=get_imagen_video, verbose_name="video_dos")
    video_tres = models.FileField(null=True, blank=True, upload_to=get_imagen_video, verbose_name="video_tres")
    video_cuatro = models.FileField(null=True, blank=True, upload_to=get_imagen_video, verbose_name="video_cuatro")
    video_cinco = models.FileField(null=True, blank=True, upload_to=get_imagen_video, verbose_name="video_cinco")
    video_seis = models.FileField(null=True, blank=True, upload_to=get_imagen_video, verbose_name="video_seis")
    ...
    ruleta_estado = models.CharField(
        _('ruleta_estado'), max_length=13, choices=RULETA_ESTADOS, default='ocultar',
        help_text='Estado')
