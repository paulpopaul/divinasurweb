...
urlpatterns = [
    ...
    path('hola/<slug:slug>/', PerfilDetailView.as_view()),
    path('contacto/', views.contacto, name='contacto'),
    path('contacto/enviando/', TemplateView.as_view(template_name="enviando.html")),
    path('enviando/', TemplateView.as_view(template_name="enviando.html")),
